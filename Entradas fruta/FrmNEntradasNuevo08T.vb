Public Class FrmNEntradasNuevo08T
    ...
    '        txtMuestra(i) = DevuelveControl(Me, "txtMuesta" & Strings.Right("00" & i, 2))
    '    Next
    ...
    Private Sub TxtPorcentaje_recol_i_Validated(sender As Object, e As EventArgs) Handles TxtPorcentaje_recol_i.Validated
        ...
        Totalizar()
    End Sub
    Private Sub FrmNEntradasNuevo08T_Load(sender As Object, e As EventArgs) Handles Me.Load
        Dim SQL As String
        Dim RsClasificacion As cnRecordset.CnRecordset = New cnRecordset.CnRecordset
        Dim i As Integer
        Dim j As Integer
        ...
        If RsEntrada!tarada_sn <> "S" Then
            FlagPreguntar = False
            MsgBox("El albarán seleccionado no ha sido tarado todavía.", MsgBoxStyle.Critical)
            CmdSalir_Click()
        End If
        Me.KeyPreview = True
        lblAlbaran.Text = CStr(RsEntrada!numero_albaran)

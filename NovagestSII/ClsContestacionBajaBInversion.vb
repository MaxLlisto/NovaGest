...
Public Class ClsContestacionBajaBInversion
    Dim cPost As String
    Dim cHost As String
    ...
    Public Sub CargaDocumento(cXML, pbR)
        ...
        cCSV = oXML.TxtReadSingleNode("/env:Envelope/env:Body/siiLR:RespuestaLRBajaBienesInversion/siiR:CSV")
        EstadoEnvio = oXML.TxtReadSingleNode("/env:Envelope/env:Body/siiLR:RespuestaLRBajaBienesInversion/siiR:EstadoEnvio")
        nodos = oXML.NodeCount("/env:Envelope/env:Body/siiLR:RespuestaLRBajaBienesInversion")
        oListadeNodos = oXML.ReadNodes("/env:Envelope/env:Body/siiLR:RespuestaLRBajaBienesInversion")

...
Inherits LibreriaModeloMantenimiento.ModeloMantenimiento
    ...
    Private Sub BtDevoluciones_Click(sender As Object, e As EventArgs) Handles BtDevoluciones.Click

    End Sub

    Private Sub BtRemesar_Click(sender As Object, e As EventArgs) Handles BtRemesar.Click

    End Sub

    Private Sub BtCartas_Click(sender As Object, e As EventArgs) Handles BtCartas.Click

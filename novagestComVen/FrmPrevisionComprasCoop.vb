...
Public Class FrmPrevisionComprasCoop
Inherits LibreriaModeloMantenimiento.ModeloMantenimiento

    Private Sub TextBox4_TextChanged(sender As Object, e As EventArgs) Handles TxtCalidad6.TextChanged

    End Sub

    Private Sub TextBox8_TextChanged(sender As Object, e As EventArgs) Handles TxtCalidad10.TextChanged

...
Public Class CoolPrintPreviewDialog
    ...
    Private Sub _btnPrint_Click(ByVal sender As Object, ByVal e As EventArgs) Handles _btnPrint.Click
        Using dlg As PrintDialog = New PrintDialog
            ...
            dlg.PrinterSettings.MaximumPage = Me._preview.PageCount
            dlg.PrinterSettings.FromPage = 1
            dlg.PrinterSettings.ToPage = Me._preview.PageCount
    ...
    Private Sub _btnZoom_DropDownItemClicked(ByVal sender As Object, ByVal e As ToolStripItemClickedEventArgs) Handles _btnZoom.DropDownItemClicked
        ...
        ZoomActual.Text = CInt(Me._preview.Zoom * 100) & "%"
    End Sub
    ...
    Private Sub Zoommas_Click(sender As Object, e As EventArgs) Handles Zoommas.Click
        Me._preview.Zoom += 0.25
        ZoomActual.Text = CInt(Me._preview.Zoom * 100) & "%"
    End Sub

    Private Sub Menoszoom_Click(sender As Object, e As EventArgs) Handles Menoszoom.Click
        If Me._preview.Zoom > 0.5 Then
            Me._preview.Zoom -= 0.25
            ZoomActual.Text = CInt(Me._preview.Zoom * 100) & "%"
            End if
    End Sub
    ...
    Private Sub ExportarPDF_Click(sender As Object, e As EventArgs) Handles ExportarPDF.Click
        Dim CldPdf As ImprimirPDF = New ImprimirPDF
        Dim ps As PrinterSettings = New PrinterSettings

        If CldPdf.Dialogoarchivo() Then
            ps.PrinterName = CldPdf.nombreimpresora
            ps.MinimumPage = 1
            ps.MaximumPage = Me._preview.PageCount
            ps.FromPage = 1
            ps.ToPage = Me._preview.PageCount

Module ModuloControl
    ...
    Public ObjetoGlobal As New ObjetoGlobal.ObjetoGlobal
    ...
    Public Sub Main()
        ...
        PathLocal = "D:\Nuevo desarrollo\__NovaGest_8\NovaGest_8\bin\ConexionLocal.txt"
        Cadena = ""
        ...
        FrmGrabacionCostes.ObjetoGlobal = ObjetoGlobal
        Application.Run(FrmGrabacionCostes)

        'Frm4.ObjetoGlobal = ObjetoGlobal
        'Application.Run(Frm4)


        '        Application.Run(FrmTestGF)
        '        Application.Run(FrmTstGG)
    End Sub
